...
This guide explains how to receive and process incoming Peppol documents using the [Recommand API](/reference/documents). It covers the two main approaches — webhooks (push) and inbox polling (pull) — and how to retrieve and process document details.
...
<Cards>
  ...
  <Card href="/reference/documents" title="Documents API Reference">

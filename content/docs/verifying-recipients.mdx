...
This guide explains how to verify if recipients exist in the Peppol network and support specific document types using the [Recommand API](/reference/recipients).

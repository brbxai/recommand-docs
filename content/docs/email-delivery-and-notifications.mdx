...
Use the [notification email address endpoints](/reference/company-notification-email-addresses) to manage notification emails programmatically.
...
<Cards>
  ...
  <Card
    href="/reference/company-notification-email-addresses"

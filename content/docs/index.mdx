...
Companies represent businesses that can send or receive Peppol documents. Each company must be registered before sending documents using the [companies endpoint](/reference/companies):

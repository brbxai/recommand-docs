...
description: Learn the fundamentals of the Peppol network — how it works, its four-corner model, participant IDs, access points, and the role of service providers.
---
